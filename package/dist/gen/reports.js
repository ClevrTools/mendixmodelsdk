...
(function (reports) {
    ...
    let BasicReportAggregate = /** @class */ (() => {
     ...
     */
    let ReportDateRangeField = /** @class */ (() => {
     ...
     */
    let ReportDateRangeSelector = /** @class */ (() => {
