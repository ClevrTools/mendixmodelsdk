...
(function (mappings) {
    ...
    let ObjectHandlingBackupEnum = /** @class */ (() => {
    ...
    let MappingMicroflowCall = /** @class */ (() => {
    ...
    let MappingMicroflowParameter = /** @class */ (() => {
    ...
    let ObjectMappingElement = /** @class */ (() => {
