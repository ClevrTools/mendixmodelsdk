...
export declare namespace datatypes {
    ...
    abstract class DataType extends internal.Element implements IDataType {
        ...
        model: IModel;
        readonly containerAsAppServiceAction: appservices.AppServiceAction;
        readonly containerAsAppServiceActionParameter: appservices.AppServiceActionParameter;
        readonly containerAsConstant: constants.Constant;
        readonly containerAsDataSetColumn: datasets.DataSetColumn;
        readonly containerAsDataSetParameter: datasets.DataSetParameter;
        readonly containerAsDocumentTemplateParameter: documenttemplates.DocumentTemplateParameter;
        readonly containerAsImportMapping: importmappings.ImportMapping;
        readonly containerAsValueMappingElement: mappings.ValueMappingElement;
        readonly containerAsCreateVariableAction: microflows.CreateVariableAction;
        readonly containerAsMicroflowBase: microflows.MicroflowBase;
        readonly containerAsMicroflowParameterBase: microflows.MicroflowParameterBase;
        readonly containerAsMicroflowParameterObject: microflows.MicroflowParameterObject;
        readonly containerAsResultHandling: microflows.ResultHandling;
        readonly containerAsRestOperationParameter: rest.RestOperationParameter;
        readonly containerAsPublishedOperation: webservices.PublishedOperation;
