...
import { IWorkingCopy, IAbstractUnitJson, IGetFilesOptions, IEnvironmentStatus, IDeployJobStatus } from "./transport-interfaces";
/**
...
export interface IAbstractModel {
     ...
     */
    exportMpk(outFilePath: string, callback: common.ICallback<number>, errorCallback?: common.IErrorCallback): void;
    exportMpk(outFilePath: string): Promise<number>;
    /**
