...
(function (webservices) {
    ...
    let HeaderAuthentication = /** @class */ (() => {
    ...
    let PublishedServiceBase = /** @class */ (() => {
    ...
    let RpcMessagePartElement = /** @class */ (() => {
     ...
     */
    let SystemIdDataAttribute = /** @class */ (() => {
