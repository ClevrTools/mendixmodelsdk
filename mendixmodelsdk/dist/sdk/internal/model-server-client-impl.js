...
const rest_transportation_1 = require("./rest-transportation");
...
class ModelServerClientImpl {
    constructor(config) {
        ...
        this.transportation = config.transportation || new rest_transportation_1.RestTransportation(config);
    }
...
//# sourceMappingURL=model-server-client-impl.js.map