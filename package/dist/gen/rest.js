...
(function (rest) {
    ...
    let RestAuthenticationType = /** @class */ (() => {
    ...
    let RestOperationParameterType = /** @class */ (() => {
     ...
     */
    let ConsumedODataService = /** @class */ (() => {
    ...
    let ODataRemoteAssociationSource = /** @class */ (() => {
        ...
        return ODataRemoteAssociationSource;
    })();
    rest.ODataRemoteAssociationSource = ODataRemoteAssociationSource;
    /**
     * In version 8.10.0: introduced
     */
    let ODataRemoteEntitySource = /** @class */ (() => {
        ...
        return ODataRemoteEntitySource;
    })();
     ...
     */
    let PublishedODataService = /** @class */ (() => {
     ...
     */
    let PublishedRestResource = /** @class */ (() => {
     ...
     */
    let PublishedRestService = /** @class */ (() => {
     ...
     * In version 7.7.0: introduced
     */
    let PublishedRestServiceOperation = /** @class */ (() => {
     ...
     * In version 7.7.0: introduced
     */
    let PublishedRestServiceResource = /** @class */ (() => {
     ...
     */
    let RestOperationParameter = /** @class */ (() => {
