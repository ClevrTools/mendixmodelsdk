...
(function (kafka) {
    ...
    class PublishedKafkaService extends projects_1.projects.Document {
        constructor(model, structureTypeName, id, isPartial, container) {
            super(model, structureTypeName, id, isPartial, container);
            /** @internal */
            this.__namespace = new internal.PrimitiveProperty(PublishedKafkaService, this, "namespace", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            ...
            /** @internal */
            this.__version = new internal.PrimitiveProperty(PublishedKafkaService, this, "version", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
