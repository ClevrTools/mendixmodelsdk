...
(function (security) {
     ...
     */
    let AccessRuleContainerBase = /** @class */ (() => {
    ...
    let FileDocumentAccessRuleContainer = /** @class */ (() => {
    ...
    let ImageAccessRuleContainer = /** @class */ (() => {
     ...
     */
    let PasswordPolicySettings = /** @class */ (() => {
