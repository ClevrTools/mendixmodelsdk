...
class TransactionManager {
    ...
    deltaReceived(delta) {
        if (delta.deltaType === "DETACH_ELEMENT") {
            const unit = delta_utils_1.asModelUnit(delta_utils_1.getUnit(this.model, delta.unitId));
            const element = delta_utils_1.getElement(this.model, unit, delta.elementId);
