...
(function (customwidgets) {
    let CustomWidgetAttributeType = /** @class */ (() => {
    ...
    let SystemPropertyEnum = /** @class */ (() => {
        ...
        return SystemPropertyEnum;
    })();
    customwidgets.SystemPropertyEnum = SystemPropertyEnum;
    let WidgetReturnTypeEnum = /** @class */ (() => {
     ...
     */
    let CustomWidgetDatabaseSource = /** @class */ (() => {
     ...
     * In version 8.5.0: introduced
     */
    let CustomWidgetXPathSource = /** @class */ (() => {
        ...
        return CustomWidgetXPathSource;
    })();
    customwidgets.CustomWidgetXPathSource = CustomWidgetXPathSource;
    let WidgetEnumerationValue = /** @class */ (() => {
