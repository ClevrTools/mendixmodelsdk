...
var datasets;
(function (datasets) {
    let DateTimeIntervalLength = /** @class */ (() => {
    ...
    let DateTimeIntervalModifier = /** @class */ (() => {
    ...
    let DataSetColumn = /** @class */ (() => {
        class DataSetColumn extends internal.Element {
            constructor(model, structureTypeName, id, isPartial, unit, container) {
                super(model, structureTypeName, id, isPartial, unit, container);
                /** @internal */
                this.__name = new internal.PrimitiveProperty(DataSetColumn, this, "name", "", internal.PrimitiveTypeEnum.String);
                /** @internal */
                this.__type = new internal.PrimitiveProperty(DataSetColumn, this, "type", "", internal.PrimitiveTypeEnum.String);
                /** @internal */
    ...
    let DataSetConstraintAccess = /** @class */ (() => {
    ...
    let DataSetParameterConstraint = /** @class */ (() => {
    ...
    let DataSetDateTimeConstraint = /** @class */ (() => {
    ...
    let DataSetModuleRoleAccess = /** @class */ (() => {
    ...
    let DataSetNumericConstraint = /** @class */ (() => {
        class DataSetNumericConstraint extends DataSetParameterConstraint {
            constructor(model, structureTypeName, id, isPartial, unit, container) {
                super(model, structureTypeName, id, isPartial, unit, container);
                /** @internal */
                this.__begin = new internal.PrimitiveProperty(DataSetNumericConstraint, this, "begin", "", internal.PrimitiveTypeEnum.String);
                /** @internal */
                this.__applyBegin = new internal.PrimitiveProperty(DataSetNumericConstraint, this, "applyBegin", false, internal.PrimitiveTypeEnum.Boolean);
                /** @internal */
                this.__end = new internal.PrimitiveProperty(DataSetNumericConstraint, this, "end", "", internal.PrimitiveTypeEnum.String);
                /** @internal */
                this.__applyEnd = new internal.PrimitiveProperty(DataSetNumericConstraint, this, "applyEnd", false, internal.PrimitiveTypeEnum.Boolean);
                if (arguments.length < 4) {
    ...
    let DataSetObjectConstraint = /** @class */ (() => {
    ...
    let DataSetParameter = /** @class */ (() => {
        class DataSetParameter extends internal.Element {
            constructor(model, structureTypeName, id, isPartial, unit, container) {
                ...
                /** @internal */
                this.__type = new internal.PrimitiveProperty(DataSetParameter, this, "type", "", internal.PrimitiveTypeEnum.String);
                /** @internal */
    ...
    let DataSetParameterAccess = /** @class */ (() => {
