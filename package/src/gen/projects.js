...
(function (projects) {
    ...
    class JarDependency extends internal.Element {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            ...
            /** @internal */
            this.__groupId = new internal.PrimitiveProperty(JarDependency, this, "groupId", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
            this.__artifactId = new internal.PrimitiveProperty(JarDependency, this, "artifactId", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
         ...
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, JarDependency.structureTypeName, { start: "10.0.0" });
            return internal.instancehelpers.createElement(container, JarDependency, "jarDependencies", true);
        }
        /**
         * Creates and returns a new JarDependency instance in the SDK and on the server.
         ...
         */
        static create(model) {
            return internal.instancehelpers.createElement(model, JarDependency);
        }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
