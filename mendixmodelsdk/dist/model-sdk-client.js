...
const utils_1 = require("./sdk/internal/utils");
/**
...
class ModelSdkClientImpl {
    ...
    createWorkingCopy(workingCopyParameters, callback, errorCallback) {
        ...
        return utils_1.promiseOrCallbacks((resolve, reject) => this.client.createWorkingCopy(workingCopyParameters, resolve, reject), callback, errorCallback);
    }
    createWorkingCopyFromTeamServer(workingCopyParameters, callback, errorCallback) {
        if (callback) {
            checkCallbacks(callback, errorCallback);
        }
        return utils_1.promiseOrCallbacks((resolve, reject) => this.client.createWorkingCopyFromTeamServer(workingCopyParameters, resolve, reject), callback, errorCallback);
    }
    createAndOpenWorkingCopy(workingCopyParameters, callback, errorCallback) {
        if (callback) {
            checkCallbacks(callback, errorCallback);
        }
        return utils_1.promiseOrCallbacks((resolve, reject) => this.client.createWorkingCopy(workingCopyParameters, workingCopyInfo => {
    ...
    exportMpk(workingCopyId, outFilePath, callback, errorCallback) {
        ...
        return utils_1.promiseOrCallbacks((resolve, reject) => this.client.exportMpk(workingCopyId, outFilePath, resolve, reject), callback, errorCallback);
    }
    exportModuleMpk(workingCopyId, moduleId, outFilePath, callback, errorCallback) {
        if (callback) {
            checkCallbacks(callback, errorCallback);
        }
        return utils_1.promiseOrCallbacks((resolve, reject) => this.client.exportModuleMpk(workingCopyId, moduleId, outFilePath, resolve, reject), callback, errorCallback);
    }
    startAppUpdate(workingCopyId, callback, errorCallback) {
        if (callback) {
            checkCallbacks(callback, errorCallback);
        }
        return utils_1.promiseOrCallbacks((resolve, reject) => this.client.startAppUpdate(workingCopyId, resolve, reject), callback, errorCallback);
    }
    getAppUpdateStatus(workingCopyId, jobId, callback, errorCallback) {
        if (callback) {
            checkCallbacks(callback, errorCallback);
        }
        return utils_1.promiseOrCallbacks((resolve, reject) => this.client.getAppUpdateStatus(workingCopyId, jobId, resolve, reject), callback, errorCallback);
    }
    getAppEnvironmentStatus(workingCopyId, callback, errorCallback) {
        if (callback) {
            checkCallbacks(callback, errorCallback);
        }
        return utils_1.promiseOrCallbacks((resolve, reject) => this.client.getAppEnvironmentStatus(workingCopyId, resolve, reject), callback, errorCallback);
    }
    getAppEnvironmentStatusV2(workingCopyId, callback, errorCallback) {
        if (callback) {
            checkCallbacks(callback, errorCallback);
        }
        return utils_1.promiseOrCallbacks((resolve, reject) => this.client.getAppEnvironmentStatusV2(workingCopyId, resolve, reject), callback, errorCallback);
    }
    getMyWorkingCopies(callback, errorCallback) {
        if (callback) {
            checkCallbacks(callback, errorCallback);
        }
        return utils_1.promiseOrCallbacks((resolve, reject) => this.client.getMyWorkingCopies(resolve, reject), callback, errorCallback);
    }
    getWorkingCopyByProject(projectId, callback, errorCallback) {
        if (callback) {
            checkCallbacks(callback, errorCallback);
        }
        return utils_1.promiseOrCallbacks((resolve, reject) => this.client.getWorkingCopyByProject(projectId, resolve, reject), callback, errorCallback);
    }
    ...
    lockWorkingCopy(workingCopyId, lockOptionsOrCallback, callbackOrErrorCallback, errorCallback) {
        ...
        return utils_1.promiseOrCallbacks((resolve, reject) => this.client.lockWorkingCopy(workingCopyId, lockOptions, resolve, reject), callback, errorCallback);
    }
    unlockWorkingCopy(workingCopyId, lockTypeOrCallback, callbackOrErrorCallback, errorCallback) {
        ...
        return utils_1.promiseOrCallbacks((resolve, reject) => this.client.unlockWorkingCopy(workingCopyId, lockType, resolve, reject), callback, errorCallback);
    }
    commitToTeamServer(workingCopyId, options, callback, errorCallback) {
        if (callback) {
            checkCallbacks(callback, errorCallback);
        }
        return utils_1.promiseOrCallbacks((resolve, reject) => this.client.commitToTeamServer(workingCopyId, options, resolve, reject), callback, errorCallback);
    }
}
