...
import { IDeployJobStatus, IEnvironmentStatus, IWorkingCopy, LockType, ILockWorkingCopyOptions, ILockWorkingCopyResponse, ICommitToTeamServerOptions } from "./sdk/internal/transport-interfaces";
import { IModelServerClient } from "./sdk/internal/model-server-client";
/**
...
export declare class ModelSdkClientImpl<IT extends internal.IAbstractModel, CT extends internal.AbstractModel & IT> {
    ...
    exportMpk(workingCopyId: string, outFilePath: string): Promise<number>;
    /**
