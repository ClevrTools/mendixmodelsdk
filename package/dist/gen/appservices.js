...
(function (appservices) {
    let AppServiceLocationEnum = /** @class */ (() => {
    ...
    let AppServiceActionParameter = /** @class */ (() => {
    ...
    let MsdEnumerationContainer = /** @class */ (() => {
    ...
    let MsdMicroflowParameter = /** @class */ (() => {
