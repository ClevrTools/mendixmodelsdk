...
const model_event_manager_1 = require("./model-events/model-event-manager");
...
class AbstractModel {
    ...
    initializeFromModelServer(workingCopyId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.metaModelVersion = version_checks_1.parseAsNormalizedVersion(workingCopy.metaData.metaModelVersion);
            this.mxVersionForModel = version_checks_1.parseAsNormalizedVersion(workingCopy.mprMetaData._ProductVersion);
            const maxMetamodelVersion = version_checks_1.Version.parse(metamodelversion_1.MAX_METAMODEL_VERSION);
            ...
            this.modelEventManager = new model_event_manager_1.ModelEventManager(this, this.deltaManager, new deltas_1.DeltaProcessor(this), workingCopyId, eventId);
    ...
    closeConnection(callback, errorCallback) {
        return utils_2.promiseOrCallbacks((resolve, reject) => {
    ...
    filterUnitsByCustomWidgetId(workingCopyId, widgetId, callback, errorCallback) {
        return utils_2.promiseOrCallbacks((resolve, reject) => this._client.filterUnitsByCustomWidgetId(workingCopyId, widgetId, resolve, reject), callback, errorCallback || this._errorHandler);
    }
    /** @internal */
    ...
    addModuleUnitInterfaces(structuresJson) {
        ...
        const moduleStructure = parsedStructures.reduce((foundModule, current) => {
            if (current.$Type === "Projects$Module") {
                if (foundModule) {
                    throw new Error("Only one module allowed in module json");
                }
                else {
                    return current;
                }
        ...
        if (!moduleStructure) {
            throw new Error("No module structure found in module json");
        }
    ...
    getFiles(arg1, arg2, arg3) {
        ...
        return utils_2.promiseOrCallbacks((resolve, reject) => this._client.getFiles(this.id, options, resolve, reject), callback, errorCallback);
    }
    getFile(filePath, outFilePath, callback, errorCallback) {
        if (callback) {
            checkErrorCallback(errorCallback);
        }
        return utils_2.promiseOrCallbacks((resolve, reject) => this._client.getFile(this.id, filePath, outFilePath, resolve, reject), callback, errorCallback);
    }
    putFile(inFilePath, filePath, callback, errorCallback) {
        if (callback) {
            checkErrorCallback(errorCallback);
        }
        return utils_2.promiseOrCallbacks((resolve, reject) => this._client.putFile(this.id, inFilePath, filePath, resolve, reject), callback, errorCallback);
    }
    deleteFile(filePath, callback, errorCallback) {
        if (callback) {
            checkErrorCallback(errorCallback);
        }
        return utils_2.promiseOrCallbacks((resolve, reject) => this._client.deleteFile(this.id, filePath, resolve, reject), callback, errorCallback);
    }
    getAppEnvironmentStatus(callback, errorCallback) {
        if (callback) {
            checkErrorCallback(errorCallback);
        }
        return utils_2.promiseOrCallbacks((resolve, reject) => this._client.getAppEnvironmentStatus(this.id, resolve, reject), callback, errorCallback);
    }
    getAppEnvironmentStatusV2(callback, errorCallback) {
        if (callback) {
            checkErrorCallback(errorCallback);
        }
        return utils_2.promiseOrCallbacks((resolve, reject) => this._client.getAppEnvironmentStatusV2(this.id, resolve, reject), callback, errorCallback);
    }
    getAppUpdateStatus(jobId, callback, errorCallback) {
        if (callback) {
            checkErrorCallback(errorCallback);
        }
        return utils_2.promiseOrCallbacks((resolve, reject) => this._client.getAppUpdateStatus(this.id, jobId, resolve, reject), callback, errorCallback);
    }
    startAppUpdate(callback, errorCallback) {
        if (callback) {
            checkErrorCallback(errorCallback);
        }
        return utils_2.promiseOrCallbacks((resolve, reject) => this._client.startAppUpdate(this.id, resolve, reject), callback, errorCallback);
    }
    /**
