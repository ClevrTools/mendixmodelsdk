...
export declare namespace texts {
    ...
    class SystemTextCollection extends projects.ProjectDocument implements ISystemTextCollection {
        ...
        readonly systemTexts: internal.IList<SystemText>;
    ...
    class Text extends internal.Element {
        ...
        readonly containerAsCallNanoflowClientAction: pages.CallNanoflowClientAction;
        ...
        readonly containerAsDropDown: pages.DropDown;
        ...
        readonly containerAsLoginTextBox: pages.LoginTextBox;
        readonly containerAsMasterDetailDetailRegion: pages.MasterDetailDetailRegion;
        ...
        readonly translations: internal.IList<Translation>;
        constructor(model: internal.AbstractModel, structureTypeName: string, id: string, isPartial: boolean, unit: internal.ModelUnit, container: internal.AbstractElement);
        /**
